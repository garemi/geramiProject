<template>
  <div class="position-relative">
    ...
    <div class="expand-width mx-0 nav-background">
      <div class="d-flex justify-space-around align-center">
          ...
          <div class="d-flex flex-column align-center">
            ...
            >
              <g
                id="Group_5"
                data-name="Group 5"
                transform="translate(-292 -876)"
              >
                <g id="analysis" transform="translate(297.769 880.385)">
                  <path
                    id="Path_9"
                    data-name="Path 9"
                    d="M17.148,6.222l-5.609,5.616L7.469,7.761a.769.769,0,0,0-1.092,0L.222,13.916a.772.772,0,0,0,1.092,1.092L6.923,9.392l4.07,4.078a.769.769,0,0,0,1.092,0L18.24,7.315a.772.772,0,1,0-1.092-1.092Z"
        ...
        <v-btn icon small>
          <div class="d-flex flex-column align-center">
            ...
            <p class="mt-1">آگهی ها</p>
          </div>
        </v-btn>
        <v-btn icon small :to="$store.state.userData ? '' : ''">
          <div class="d-flex flex-column align-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
