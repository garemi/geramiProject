<template>
  <v-navigation-drawer v-model="show" right app temporary draggable>
    <v-row class="fill-height" no-gutters style="min-width: 250px">
        ...
        <transition name="fade">
          <span :key="selectedCategory">
            <div
              ...
              :class="{
                'custom-shadow selected grey--text mx-2': selectedPath.includes(
                  item.path,
                ),
              }"
            >
...
<style scoped lang="scss">
  ...
  /* .main-drawer {
  background: #7100ce;
  background: -webkit-linear-gradient(to bottom, #6d45fd, #7043f7, #7100ce);
  background: linear-gradient(to bottom, #6d45fd, #7043f7, #7100ce);
